...
/*
 * Title                   : St Barth View
 * File                    : application/views/frontend/offers/templates/content-templates/deals-slider-template.php
 * File Version            : 1.0
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 30 June 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Offers - Offer Deals Slider Template.
*/

?>
    <div id="deals-slider" class="hidden-slider">
        <div class="slider-left"> <a href="javascript:offer_hideDealsSlider(null)">>></a> </div>
