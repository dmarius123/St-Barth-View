...
/*
 * Title                   : St Barth View
 * File                    : application/views/frontend/user/forms/offers/offer-hotel-details-form.php
 * File Version            : 1.0
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 27 May 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Login User - Offer Hotel Details form.
*/

?>
    <h3 id="add-offer-details-title"><?=$user_add_hotel_details_title?></h3>
