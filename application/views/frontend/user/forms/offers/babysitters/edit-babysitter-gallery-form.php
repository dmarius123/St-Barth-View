...
/*
 * Title                   : St Barth View
 * File                    : application/views/frontend/user/forms/offers/babysitters/edit-babysitter-gallery-form.php
 * File Version            : 1.0
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 03 July 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Login User - Edit Babysitter Gallery form.
*/

?>
    <h3 id="edit-offer-gallery-title"><?=$user_edit_babysitter_gallery_title?></h3>
