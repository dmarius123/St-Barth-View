...
/*
 * Title                   : St Barth View
 * File                    : application/views/frontend/user/forms/offers/cars/edit-car-gallery-form.php
 * File Version            : 1.0
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 03 July 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Login User - Edit Car Gallery form.
*/

?>
    <h3 id="edit-offer-gallery-title"><?=$user_edit_car_gallery_title?></h3>
