...
/*
 * Title                   : St Barth View
 * File                    : application/views/frontend/user/templates/offers/add-chef-template.php
 * File Version            : 1.0
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 03 July 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Login User - Add Chef content.
*/

?>
    <h2><?=$user_add_chef_title?></h2>
...
<?php $this->load->view('frontend/user/forms/offers/offer-details-form'); ?>
    <input type="submit" name="submit" id="submit" class="user-area-submit-style" onclick="user_addChef()" value="<?=$user_add_chef_submit?>" />
