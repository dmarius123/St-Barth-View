...
/*
 * Title                   : St Barth View
 * File                    : application/controllers/pages/faq.php
 * File Version            : 1.2
 * Author                  : Marius-Cristian Donea
 * Created / Last Modified : 30 June 2011
 * Last Modified By        : Marius-Cristian Donea
 * Description             : Pages - FAQ Controller.
*/
    ...
    class Faq extends CI_Controller{
        ...
        public function index(){
            ...
            $data['header_subtitle'] = ' - '.$data['footer_faq'];
            ...
            $this->load->view('frontend/pages/templates/faq-template', $data);
        }
    }
